...
public class DeleteCardNote implements Command {
    private static Logger logger = LogManager.getLogger(DeleteCardNote.class);
    private static final String PART_OF_URL = "/Controller?command=take_user_card&user_id=";

    /**
     * Метод удаляет запись в карточке пользователя.
     *
     * @param req
     * @param resp
    ...
    public void execute(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        ...
        try {
            ...
            if (user != null) {
                ...
                libService.deleteCardNote(cardNoteId);
